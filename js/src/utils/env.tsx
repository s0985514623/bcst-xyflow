...
const APP_DOMAIN = 'bcst_xyflow_data' as string
export const snake = window?.[APP_DOMAIN]?.env?.SNAKE || 'bcst_xyflow'
export const appName = window?.[APP_DOMAIN]?.env?.APP_NAME || 'BCST XYFlow'
export const kebab = window?.[APP_DOMAIN]?.env?.KEBAB || 'bcst-xyflow'
export const app1Selector =
  window?.[APP_DOMAIN]?.env?.APP1_SELECTOR || '#bcst_xyflow'
export const app2Selector =
  window?.[APP_DOMAIN]?.env?.APP2_SELECTOR || '#bcst_xyflow_metabox'
